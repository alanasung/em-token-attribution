...
This note situates **Which Tokens Drive Emergent Misalignment** against the motivating literature for
[Which Tokens Drive Emergent Misalignment](https://github.com/alanasung/em-token-attribution).

## Positioning

Attribute emergent misalignment to token-level patterns in fine-tuning documents on small models.

The design hypothesis is: Attribute emergent misalignment to token-level patterns in fine-tuning documents on small models.
