"""Experiment stages for Which Tokens Drive Emergent Misalignment."""
...
from .emtoken._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(
        out / "report.json",
        {"headline": "Which Tokens Drive Emergent Misalignment", "claims_gated": True},
    )
