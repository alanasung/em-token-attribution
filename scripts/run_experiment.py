...
from emtoken.configs.loader import register_schema
...
def _load_stage_registry(package: str = "emtoken") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in emtoken.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from emtoken.configs.loader import config_to_dict, save_resolved_config
    from emtoken.models.device import get_device
    from emtoken.utils.logging import configure_logging
    from emtoken.utils.reproducibility import set_seed
    from emtoken.utils.run_manifest import create_run_dir, save_run_metadata
