<p align="center">
  ...
  <p align="center">SPAR Fall 2026 · <a href="https://github.com/alanasung/em-token-attribution">Which Tokens Drive Emergent Misalignment</a></p>
</p>
...
**Which Tokens Drive Emergent Misalignment**. The shared engineering spine (config, caching, hooks, metrics,
...
| Stage | Module | Output |
|---|---|---|
| Compose config | `configs/` + `emtoken.configs` | resolved `config.yaml` |
| Build data | `emtoken.data` | splits + manifest |
| Load model | `emtoken.models` | `LoadedModel` + resolved commit |
| Run stages | `scripts/run_experiment.py` | per-stage JSON |
| Aggregate | `emtoken.reporting` | `results.json` + tables + figures |
...
├── src/emtoken/       # installable library (print-free)
...
- SPAR Fall 2026 project posting: https://github.com/alanasung/em-token-attribution
- Complexity bar: Critical Data PRIMED-AI / RecursiveJEPA engineering standard

## Citation

```bibtex
@misc{emtoken_spar_f26,
  title        = {Which Tokens Drive Emergent Misalignment},
  author       = {Alana Sung},
  year         = {2026},
  howpublished = {SPAR Fall 2026},
  note         = {Attribute emergent misalignment to token-level patterns in fine-tuning documents on small models.},
  url          = {https://github.com/alanasung/em-token-attribution}
}
```
...
Ablations live under `src/emtoken/ablation/` and return structured dicts. Presets
