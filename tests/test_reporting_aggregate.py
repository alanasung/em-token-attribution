import json
from emtoken.reporting.aggregate import aggregate_results, flatten_metrics
from emtoken.reporting.tables import write_tables
from emtoken.reporting.figures import write_caption, write_figures
